...
jweinhart ALL=(root) NOPASSWD: /bin/systemctl start NetworkManager
jweinhart ALL=(root) NOPASSWD: /bin/systemctl stop NetworkManager
jweinhart ALL=(root) NOPASSWD: /bin/systemctl restart NetworkManager
